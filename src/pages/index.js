...
function Index() {
    return (
        <div className='flex flex-col'>
            <div className='mt-14 xl:mt-0 md:flex flex-row justify-between'>
                ...
                <Image
                className='mt-5 sm:mt-0 w-[180] h-[100] sm:w-[400px] sm:h-[340px] md:w-[320px] md:h-[270px] lg:w-[400px] lg:h-[340px] xl:w-[490px] xl:h-[400px]'
                alt=""
