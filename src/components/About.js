        ...
        <section id="about" className="py-10 md:py-15 lg:py-20">
            ...
            <div className="max-w-3xl">
                ...
                <div className="space-y-6 text-sm md:text-lg text-gray-500 leading-relaxed font-light">
                    <p>
                        Over the past few years, I’ve <span className='link-style'><Link target='_blank' href="https://github.com/omavhad">built</Link></span> across diverse projects, internships, 
                    ...
                    <p>
                        ...
                        These values reflect <span className='link-style'><Link target='_blank' href="https://drive.google.com/file/d/1W__3mjxFqQKSIu5vKB-OwDact8q8LkVR/view?usp=drive_linkhttps://github.com/omavhad">me</Link></span> and
                        my <span className='link-style'><Link target='_blank' href="https://www.linkedin.com/in/omavhad/">journey</Link></span>, guiding how I build software.
                    </p>
                    ...
                    <p>
                       ...
                       If you’re curious, you can check out some of my <span className='link-style'><Link target='_blank' href="/treks">treks</Link></span> too.
                    </p>
                </div>
            </div>
        </section>
